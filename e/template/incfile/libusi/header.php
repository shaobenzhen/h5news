...
<link href="/skin/member/<?=$public_r['add_931E619D8CADEF77']?>css/bootstrap.min.css" rel="stylesheet">
<link href="/skin/member/<?=$public_r['add_931E619D8CADEF77']?>font-awesome/css/font-awesome.css" rel="stylesheet">
<link href="/skin/member/<?=$public_r['add_931E619D8CADEF77']?>css/animate.css" rel="stylesheet">
<link href="/skin/member/<?=$public_r['add_931E619D8CADEF77']?>css/style.css" rel="stylesheet">
</head>
<body>
...
<?php
require(ECMS_PATH.'e/member/'.$public_r['add_931E619D8CADEF77'].'memberlefttop.php');
?>
        </ul>
      </li>
...
<?php
require(ECMS_PATH.'e/member/'.$public_r['add_931E619D8CADEF77'].'memberleftbottom.php');
?>
    </ul>
  </div>
</nav>
...
<nav class="navbar navbar-static-top  " role="navigation" style="margin-bottom: 0">
  ...
  <ul class="nav metismenu<?=esub(html($navinfor[a]),n)?>" id="side-menu">
    <li class="nav-header">
      <div class="dropdown profile-element"> <span>
     <?php
require(ECMS_PATH.'e/member/'.$public_r['add_931E619D8CADEF77'].'memberleft.php');
?>
    <li> <a href="#"><i class="fa fa-file-text"></i> <span class="nav-label">投稿</span> <span class="fa arrow"></span></a>
      <ul class="nav nav-second-level">
        <?php
...
<?php
require(ECMS_PATH.'e/member/'.$public_r['add_931E619D8CADEF77'].'memberbuycar.php');
?>
  </ul>
  </div>
</nav>

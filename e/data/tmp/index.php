...
<meta name="description" content="h5新闻网站。" />
<meta name="keywords" content="新闻,h5" />
    ...
    <div id="sitenews-wrap" class="container">
      <div class="contextual bg-sitenews"> <i class="fa fa-volume-up" style=""></i>
        <div id="news-scroll-zone">
          <div class="news-scroll-list"> <? @sys_GetEcmsInfo(0,3,50,0,3,16,0,'isgood=8');?> </div>
        </div>
...
$(document).ready(function(){
    ...
    <section id="home-featured" class="clr">
      <div id="home-slider" class="container">
        <div id="flexslider" class="flexslider flexslider-nar">
          <ul class="slides">
            <?=$public_r['add_ecms802-flashpic']?>
            <? @sys_GetEcmsInfo(0,5,40,0,3,15,0,'firsttitle=8');?>
          </ul>
        </div>
        <div id="flexslider-right"> <span class="slider-newest">
          <div class="slider-newest-title">
            <h2>热门动态</h2>
          </div>
          <div class="slider-newest-articles"> <? @sys_GetEcmsInfo(0,3,40,0,3,14,0,'firsttitle=9');?> </div>
          </span> </div>
      </div>
    </section>
    <div class="container two-col-container">
      <div id="main-wrap-left">
        <section class="stickys clr">
          <h2 class="home-heading clr"> <span class="heading-text-blog"> 置顶推荐 </span> </h2>
          <div class="stickys-container stickys-two-col stickys-latest-list clr"> <? @sys_GetEcmsInfo(0,4,40,0,3,1,0,'isgood=9');?> </div>
        </section>
        <div class="bloglist-container clr">
          <h2 class="home-heading clr"> <span class="heading-text-blog"> 最新文章 </span> </h2>
          <? @sys_GetEcmsInfo(0,30,45,0,3,13,0);?>
          <div id="loopad" class="container banner"> </div>
        </div>
        <div class="clear"></div>
      </div>
      <script type="text/javascript">
  ...
  <div id="ft-wg-sr">
    <div class="container">
      <div id="tinbookmarkh-2" class="widget widget_tinbookmarkh">
        <h3><span class=widget-title>友情链接</span></h3>
        <div class="tinbookmarkh">
          <ul>
            <?php
$bqno=0;
...
$bqno++;
?>
            <li class="tinbookmarkh-list"><a href="<?=$bqr[lurl]?>" title="<?=$bqr[lname]?>" target="_blank">
              <?=$bqr[lname]?>
              </a></li>
            <?php
}

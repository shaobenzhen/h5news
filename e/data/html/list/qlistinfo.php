...
require(ECMS_PATH.'e/template/incfile/'.$public_r['add_931E619D8CADEF77'].'header.php');
?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
    <td width="9%" height="25"<?=$indexchecked==0?' class="header"':' bgcolor="#C9F1FF"'?>><div align="center"><a href="ListInfo.php?mid=<?=$mid?>">已发布</a></div></td>
    <td width="9%"<?=$indexchecked==1?' class="header"':' bgcolor="#C9F1FF"'?>><div align="center"><a href="ListInfo.php?mid=<?=$mid?>&ecmscheck=1">待审核</a></div></td>
    <td width="23%">&nbsp;</td>
    <td width="47%">&nbsp;</td>
    <td width="6%">&nbsp;</td>
    <td width="6%">&nbsp;</td>
...
<?php
require(ECMS_PATH.'e/template/incfile/'.$public_r['add_931E619D8CADEF77'].'footer.php');
?>
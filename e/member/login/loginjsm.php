...
{
?>
document.write("<span data-sign=\"0\" class=\"btn btn-primary \"> <a href=\"/e/DoInfo/ChangeClass.php?mid=1\">  <i class=\"fa fa-file-text\"></i> 投稿</a></span>  <span data-sign=\"1\" class=\"btn btn-success\"><a href=\"/e/member/doaction.php?enews=exit&ecmsfrom=9\" onclick=\"return confirm(\'确认要退出?\');\">  <i class=\"fa fa-sign-out\"></i> 退出</a></span>");
<?
}
else
{
?>
document.write("<span data-sign=\"0\" class=\"btn btn-success\"><i class=\"fa fa-user\"></i> <a href=\"/e/member/login/\">登录 </a></span>  <span data-sign=\"1\" class=\"btn btn-success\"><i class=\"fa fa-plus-square\"></i> <a href=\"/e/member/register/ChangeRegister.php\">  注册</a></span>");
<?
}
?>
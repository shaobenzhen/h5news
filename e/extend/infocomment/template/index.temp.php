...
?>
	<table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" style="word-break:break-all; word-wrap:break-all;line-height: 32px; padding: 9px 9px 1px;<?=esub(html($navinfor[l]),px)?> margin-top: 22px; border-radius: 5px; border: 1px dotted rgb(221, 221, 221); font-size: 14px;border-collapse:separate;word-wrap:break-word;">
		<tr> 
        ...
        <tr> 
          <td height="30">&nbsp;</td>
          <td><div align="right" class="re<?=esub(html($navinfor[i]),span)?>"><a href="#tosaypl"<?=$includelink?>>回复</a>&nbsp; 
